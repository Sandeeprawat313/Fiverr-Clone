...
let footer = () => {
    ...
    <div class="footerBox">
      <div class="colBox">
        <div class="col1 col">
          <article class="categories collapse">
        ...
        <div class="col1 col">
          <article class="categories collapse">
            <div class="catergoriesHeading catergoriesHeading1">
              <h6 class="text-display-7 text-display-8">About</h6>
            </div>
            <div class="footerlistBox">
              <ul class="footerlist">
                <li><a href="#" rel="">Careers</a></li>
                <li><a href="#" rel="">Press &amp; News</a></li>
                <li><a href="#" rel="">Partnerships</a></li>
                <li><a href="#" rel="">Privacy Policy</a></li>
                <li><a href="#" rel="">Terms of Service</a></li>
                <li><a href="#" rel="">Intellectual Property Claims</a></li>
                <li>
                  <a href="#" target="_blank" rel="">Investor Relations</a>
                </li>
              </ul>
            </div>
          </article>
        ...
        <div class="col1 col">
          <article class="categories collapse">
            <div class="catergoriesHeading">
              <h6 class="text-display-7">Support</h6>
            </div>
            <div class="footerlistBox">
              <ul class="footerlist">
                ...
                <li><a href="#" rel="">Buying on Fiverr</a></li>
              </ul>
            </div>
          </article>
        </div>
          ...
          <article class="categories collapse">
            ...
            <div class="footerlistBox">
              <ul class="footerlist">
                ...
                <li><a href="#" rel="">Community Standards</a></li>
                <li><a href="#" rel="noopener nofollow">Podcast</a></li>
                <li><a href="#">Affiliates</a></li>
                <li><a href="#" rel="">Invite a Friend</a></li>
                <li><a href="#" rel="">Become a Seller</a></li>
              </ul>
            </div>
          </article>
        </div>
        <div class="col1 col">
          <article class="categories collapse">
            <div class="catergoriesHeading">
              <h6 class="text-display-7">More From Fiverr</h6>
            </div>
            <div class="footerlistBox">
              <ul class="footerlist">
                <li><a href="#" rel="">Fiverr Business</a></li>
                <li><a href="#" rel="">Fiverr Pro</a></li>
                <li><a href="#" rel="">Fiverr Studios</a></li>
                <li><a href="#" rel="">Fiverr Logo Maker</a></li>
                <li><a href="#">Fiverr Guides</a></li>
                <li><a href="#">Get Inspired</a></li>
                <li>
                  <a href="#"
                    >ClearVoice
                    <p>Content Marketing</p></a
                  >
                </li>
                <li>
                  <a href="#b"
                    >Fiverr Workspace
                    <p>Invoice Software</p></a
                  >
                </li>
                <li>
                  <a href="#"
                    >Learn
                    <p>Online Courses</p></a
                  >
                </li>
      ...
      <div class="bottom">
        <div class="left">
          ...
          <p class="text-body-2 legal">
            <span class="copyright text-trunc"
              >©
        ...
        <div class="right">
          <ul class="social">
            ...
            <li>
              <a
                href="https://instagram.com/fiverr"
                target="_blank"
                rel="noopener"
                class="social-link"
          ...
          <section class="settings-buttons">
            <section
              class="locale-settings-package settings-button locale_settings-package locale-settings-package locale_settings-package"
            >
              <button
                class="selection-trigger language-selection-trigger text-body-2 default"
              >
                <span
                  class="XQskgrQ trigger-icon"
            ...
            >
              <button
                class="selection-trigger currency-selection-trigger text-body-2 default"
              >
                ₹ INR
              </button>
            </section>
            <button class="accessibility-button">
              <span
                class="XQskgrQ accessibility-icon"
